...
\begin{lstlisting}[language=C++, caption={Листинг 5.1. Пример кода BLE Server (ESP32)}]
#include <BLEDevice.h>
#include <BLEUtils.h>
#include <BLEServer.h>

// UUIDs (Generate your own for production)
...
class MyCallbacks: public BLECharacteristicCallbacks {
    void onWrite(BLECharacteristic *pCharacteristic) {
      ...
      if (rxValue.length() > 0) {
        ...
        // Send ACK back via TX characteristic
...
void setup() {
  ...
  pTxCharacteristic->addDescriptor(new BLE2902()); // Needed for Notify
...
void loop() {
    ...
    if (deviceConnected) {
        // Logic to send data periodically can be here
    }
    // disconnecting
