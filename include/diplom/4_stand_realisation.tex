...
Работа с анализатором трафика в Wireshark ~\cite{wireshark_user_guide} осуществляется интуитивно понятно через графический интерфейс и состоит из следующих этапов:
